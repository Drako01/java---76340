...
SELECT nombre, telefono FROM usuarios WHERE marca = "BLACKBERRY" OR marca = "NOKIA" OR marca = "SONY"; -- Incorrecto
SELECT nombre, telefono FROM usuarios WHERE marca IN ("BLACKBERRY" , "NOKIA" , "SONY"); -- Correcto
